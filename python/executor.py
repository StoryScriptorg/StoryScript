    ...
    def add(self, command, keep_float):
        ...
        try:
            try:
                ...
                if command[0] in allvar: # Check If command index 0 is a variable
                ...
                if command[2] in allvar: # Check If command index 2 is a variable
