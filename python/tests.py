...
class TestReturnedValue(unittest.TestCase):
    ...
    def test_exceptions(self):
        self.assertEqual(processor.execute("throw DivideByZeroException"), "DivideByZeroException: You cannot divide numbers with 0")
        self.assertEqual(processor.execute("throw InvalidValue Description"), "InvalidValue: Description")
        self.assertEqual(processor.execute('throw InvalidSyntax "You did something wrong!"'), "InvalidSyntax: You did something wrong!")
        self.assertEqual(processor.execute('throw AlreadyDefined "This person is already defined."'), "AlreadyDefined: This person is already defined.")
        self.assertEqual(processor.execute("throw NotImplementedException This feature is in Alpha. Please add a Alpha tester profile to use this Feature."), "NotImplementedException: This feature is in Alpha. Please add a Alpha tester profile to use this Feature.")
        self.assertEqual(processor.execute("throw DivideByZeroException"), "DivideByZeroException: You cannot divide numbers with 0")
        self.assertEqual(processor.execute("throw InvalidTypeException The input type cannot be an Iterable data."), "InvalidTypeException: The input type cannot be an Iterable data.")
    ...
    def test_variable(self):
        ...
        self.assertEqual(processor.execute("print (a)"), "InvalidSyntax: Unknown character \"a\" in Math expression.")
    ...
    def test_input(self):
        ...
        self.assertEqual(processor.execute("print (e)"), "This file is used for Simulating user input.")
        sys.stdin.close()
    ...
    def test_if_else(self):
        ...
        self.assertEqual(processor.execute("if b == 10 then print (\"b is equal to 10\") end"), None)

    def test_switch_case(self):
        self.assertEqual(processor.execute("float c = 20.0"), None)
        self.assertEqual(processor.execute('switch c case 10.0 print ("The value of c is 10") break case 20.0 print ("The value of c is 20.") break end'), None)

    def test_ternary_operator(self):
        self.assertEqual(processor.execute('int d = 10'), None)
        self.assertEqual(processor.execute('? d >= 10 : print ("a is more than or equal to 10") : print ("a is less than 10") :'), None)
